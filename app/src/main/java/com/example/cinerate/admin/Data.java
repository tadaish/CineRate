...
public class Data {
    ...
    public void loadData(){
        ...
        if(!isDataLoaded){
            HomePageActivity.movieDAO.addMovie(new Movie("Avengers: Endgame",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Godzilla x Kong: The New Empire",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Dune",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("The Platform",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Men in Black 1",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Deadpool & Wolverine",
            ...
            //Hoạt hình
            HomePageActivity.movieDAO.addMovie(new Movie("SPY x FAMILY CODE: White",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Doraemon: Nobita và bản giao hưởng Địa Cầu ",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Kung Fu Panda 4",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Thám tử lừng danh Conan: Tàu ngầm sắt màu đen",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Klaus",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("The Super Mario Bros. Movie",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Puss in Boots: The Last Wish",
            ...
            //Chiến tranh
            HomePageActivity.movieDAO.addMovie(new Movie("The Pianist",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Giải cứu binh nhì Ryan",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Phía Tây không có gì lạ",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("T-34",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("The Exorcist",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Ringu 0",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("https://youtu.be/x_TSgCjSoOQ",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Talk to Me",
            ...
            //Hài
            HomePageActivity.movieDAO.addMovie(new Movie("Nhà có 5 nàng tiên",
                    ...
                    1, 3));
            HomePageActivity.movieDAO.addMovie(new Movie("Bỗng dưng trúng số",
                    ...
                    4, 3));
            HomePageActivity.movieDAO.addMovie(new Movie("Bà Thím Báo Thù",
                    ...
                    4, 3));
            HomePageActivity.movieDAO.addMovie(new Movie("Giờ cao điểm",
                    ...
                    2, 3));
            //Hành động
            HomePageActivity.movieDAO.addMovie(new Movie("Mad Max 2",
                    ...
                    2, 2));
            HomePageActivity.movieDAO.addMovie(new Movie("The Terminator",
                    ...
                    2, 2));
            HomePageActivity.movieDAO.addMovie(new Movie("Terminator 2: Judgment Day",
                    ...
                    2, 2));
            HomePageActivity.movieDAO.addMovie(new Movie("The Good, the Bad and the Ugly",
                    ...
                    2, 2));
            //Lãng mạn
            HomePageActivity.movieDAO.addMovie(new Movie("ReLIFE",
            ...
            HomePageActivity.movieDAO.addMovie(new Movie("Call Me by Your Name",
                    ...
                    2, 6));
            HomePageActivity.movieDAO.addMovie(new Movie("The Shape of Water",
            ...
            HomePageActivity.languageDAO.addLanguage(new Language("Tiếng Việt"));
            HomePageActivity.languageDAO.addLanguage(new Language("Tiếng Anh"));
            HomePageActivity.languageDAO.addLanguage(new Language("Tiếng Nhật"));
            HomePageActivity.languageDAO.addLanguage(new Language("Tiếng Hàn"));
            HomePageActivity.languageDAO.addLanguage(new Language("Tiếng Nga"));
            HomePageActivity.languageDAO.addLanguage(new Language("Tiếng Tây Ban Nha"));
            HomePageActivity.languageDAO.addLanguage(new Language("Tiếng Đức"));

            HomePageActivity.genreDAO.addGenre(new Genre("Kinh dị"));
            HomePageActivity.genreDAO.addGenre(new Genre("Hành động"));
            HomePageActivity.genreDAO.addGenre(new Genre("Hài"));
            HomePageActivity.genreDAO.addGenre(new Genre("Hoạt hình"));
            HomePageActivity.genreDAO.addGenre(new Genre("Viễn tưởng"));
            HomePageActivity.genreDAO.addGenre(new Genre("Lãng mạn"));
            HomePageActivity.genreDAO.addGenre(new Genre("Chiến tranh"));

            HomePageActivity.userDAO.addUser(new User("Admin","1234", "admin"));
            HomePageActivity.userDAO.addUser(new User("u1","1234", "user"));
            HomePageActivity.userDAO.addUser(new User("u2","1234", "user"));
